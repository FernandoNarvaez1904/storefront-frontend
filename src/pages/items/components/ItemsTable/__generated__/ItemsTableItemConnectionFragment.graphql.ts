...
export type ItemsTableItemConnectionFragment$data = {
  ...
  readonly " $fragmentType": "ItemsTableItemConnectionFragment";
};
export type ItemsTableItemConnectionFragment$key = {
  readonly " $data"?: ItemsTableItemConnectionFragment$data;
...
const node: ReaderFragment = {
  ...
  "selections": [
    {
      "alias": "itemConnection",
      "args": null,
      "concreteType": "ItemTypeConnection",
      "kind": "LinkedField",
      "name": "__ItemsTableItemConnectionFragment_itemConnection_connection",
      "plural": false,
      "selections": [
        {
          "alias": null,
